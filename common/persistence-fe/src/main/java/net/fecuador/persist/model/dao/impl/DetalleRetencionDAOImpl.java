...
public class DetalleRetencionDAOImpl extends GenericDAOImpl<DetalleRetencionEntity, Integer> implements DetalleRetencionDAO {
    ...
    public void insertEntity(DetalleRetencionEntity objEntidad) {
        try {
            ...
            Logger.getLogger(DetalleRetencionDAOImpl.class.getName()).log(Level.INFO, null, "Error al Insertar Objeto");
            Logger.getLogger(DetalleRetencionDAOImpl.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void eliminarEntity(DetalleRetencionEntity objEntidad) {
        try {
            ...
            em.getTransaction().rollback();
            Logger.getLogger(DetalleRetencionDAOImpl.class.getName()).log(Level.INFO, null, "Error al Eliminar Objeto");
            Logger.getLogger(DetalleRetencionDAOImpl.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
