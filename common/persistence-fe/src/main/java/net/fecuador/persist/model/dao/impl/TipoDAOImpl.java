 ...
 */
public class TipoDAOImpl extends GenericDAOImpl<RetencionEntity, Integer> implements RetencionDAO {
    public TipoDAOImpl() {
    ...
    public void insertEntity(RetencionEntity objEntidad) {
        try {
            ...
            Logger.getLogger(TipoDAOImpl.class.getName()).log(Level.INFO, null, "Error al Insertar Objeto");
    ...
    public void eliminarEntity(RetencionEntity objEntidad) {
        try {
            ...
            em.getTransaction().rollback();
            Logger.getLogger(TipoDAOImpl.class.getName()).log(Level.INFO, null, "Error al Eliminar Objeto");
            Logger.getLogger(TipoDAOImpl.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
