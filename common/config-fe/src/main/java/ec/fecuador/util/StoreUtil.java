...
public class StoreUtil {
    ...
    public static void storeFile(String empresa, String tipo, String name, byte data[]) throws Exception {
        ...
        cm.loadValuesFromConfigurationFile();
        String base = cm.getStorePath();
        if (!base.endsWith("/")) {
            base += "/";
        }
    ...
    public static InputStream openFile(String empresa, String tipo, String name) throws IOException {
     ...
     public static byte[] openFileAsBytes(String empresa, String tipo, String name) throws IOException, Exception {
         ConfigurationManager configurationManager= ConfigurationManager.getInstance();
         configurationManager.loadValuesFromConfigurationFile();
        String base = configurationManager.getStorePath();
        if (!base.endsWith("/")) {
            base += "/";
        }
        String path = base + empresa + "/" + tipo + "/" + name;
