...
@ManagedBean
@ViewScoped
public class GraficosProveedores implements Serializable {
    ...
    private void updateData() {
        ...
        try {
            List<TopConsulta> list = facturaDao.getTopCompras(login.getEmpresaTrabajo(), desde, hasta);
            ...
            comprasSeries.setLabel("Proveedores");
            barData.clear();
